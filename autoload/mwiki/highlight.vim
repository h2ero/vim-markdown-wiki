...
function! mwiki#highlight#init()
    let syntaxs = {'go':'go','lua':'lua','java':'java', 'c':'c','php':'php','python':'python','sql':'sql','css':'css','html':'html','sh':'sh','javascript':'javascript','js':'javascript','text':'sh','conf':'conf', 'vim':'vim'}
